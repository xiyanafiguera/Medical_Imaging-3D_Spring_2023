...
write_vtk('/Users/xiyana/Downloads/med-course/homeworks/hw2/mask/mask1_new_mesh.vtk', v1_new_mesh, f1_new_mesh-1)
write_vtk('/Users/xiyana/Downloads/med-course/homeworks/hw2/mask/mask2_new_mesh.vtk', v2_new_mesh, f2_new_mesh-1)
write_vtk('/Users/xiyana/Downloads/med-course/homeworks/hw2/mask/mask3_new_mesh.vtk', v3_new_mesh, f3_new_mesh-1)
write_vtk('/Users/xiyana/Downloads/med-course/homeworks/hw2/mask/mask4_new_mesh.vtk', v4_new_mesh, f4_new_mesh-1)

save('/Users/xiyana/Downloads/med-course/homeworks/hw2/mat/v1_new_mesh.mat', 'v1_new_mesh')
save('/Users/xiyana/Downloads/med-course/homeworks/hw2/mat/v2_new_mesh.mat', 'v2_new_mesh')
save('/Users/xiyana/Downloads/med-course/homeworks/hw2/mat/v3_new_mesh.mat', 'v3_new_mesh')
save('/Users/xiyana/Downloads/med-course/homeworks/hw2/mat/v4_new_mesh.mat', 'v4_new_mesh')


save('/Users/xiyana/Downloads/med-course/homeworks/hw2/mat/f1_new_mesh.mat', 'f1_new_mesh')
save('/Users/xiyana/Downloads/med-course/homeworks/hw2/mat/f2_new_mesh.mat', 'f2_new_mesh')
save('/Users/xiyana/Downloads/med-course/homeworks/hw2/mat/f3_new_mesh.mat', 'f3_new_mesh')
save('/Users/xiyana/Downloads/med-course/homeworks/hw2/mat/f4_new_mesh.mat', 'f4_new_mesh')
...
function [mesh_new_v, mesh_new_f] = get_new_mesh(matrix,mask,level)
       ...
       [x,highest] = max(binsizes);
       highest_element = find(bins == highest);
       indices = ismember(f, highest_element);
       ...
       for i=1:length(mesh_new)
            ...
            vtx_s = mesh_new(i, :);
            mesh_new_f (i,M('v1')) = find(highest_element == vtx_s(M('v1')));
            mesh_new_f (i,M('v2')) = find(highest_element == vtx_s(M('v2')));
            mesh_new_f (i,M('v3')) = find(highest_element == vtx_s(M('v3')));
            
       end
       mesh_v = v(highest_element,:);
